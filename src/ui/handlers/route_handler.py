...
class RouteHandler(QObject):
    ...
    def find_fastest_route(self):
        ...
        from .route_handler_components.fastest_route import find_fastest_route

        find_fastest_route(handler=self)
    
    def auto_fix_route_from_button(self):
        """Auto-fix route when button is clicked."""
        from .route_handler_components.fastest_route import auto_fix_route_from_button

        auto_fix_route_from_button(handler=self)
